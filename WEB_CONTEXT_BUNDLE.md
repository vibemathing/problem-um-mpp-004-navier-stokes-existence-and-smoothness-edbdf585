...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/MPP-004"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-v1",
      "problem_contract_sha256": "cd05b3d68ccd478fd2e67d046ef50eead21187e60c66119def30c82a48c7df64",
      "problem_id": "problem:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585",
      "route_id": "route:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-source-fidelity-01",
      "graph_id": "graph:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Prove or give a counterexample: Do solutions to the Navier–Stokes equations in three dimensions always exist and remain smooth for all time?"
          },
          "statement_sha256": "fcbc4e0143f20ab853cac101193ee4b46714a4b3f4beb93ab8cd22af68fdfce5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-root",
      "route_id": "route:um-mpp-004-navier-stokes-existence-and-smoothness-edbdf585-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Partial Differential Equations problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-mpp-004-68336520c732",
        "url": "https://www.unsolvedmath.com/problems/MPP-004"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
